...
%>
<script type="text/javascript" src="<%=appmap%><%=ReportConfig.raqsoftDir%>/echarts/echarts.js"></script>
<script type="text/javascript" src="<%=appmap%><%=ReportConfig.raqsoftDir%>/echarts/ecStat.min.js"></script>
<script type="text/javascript" src="<%=appmap%><%=ReportConfig.raqsoftDir%>/echarts/echarts-gl.min.js"></script>
<script type="text/javascript" src="<%=appmap%><%=ReportConfig.raqsoftDir%>/echarts/d3.v5.min.js"></script>
