...
<head>
	...
	<script type="text/javascript" src="<%=guideDir %>js/ctx/common.js?v=<%=v %>"></script>
	...
	<script type="text/javascript" src="<%=guideDir %>js/ctx/dqlApi.js?v=<%=v %>"></script>
	...
	<script type="text/javascript" src="<%=guideDir %>js/ctx/where.js?v=<%=v %>"></script>
	...
	<%}else{%>
	<script type="text/javascript" src="<%=guideDir %>js/ctx/query.js?v=<%=v %>"></script>
	<script type="text/javascript" src="<%=guideDir %>js/ctx/dqlreport.js?v=<%=v %>"></script>
	<%}%>
	<script type="text/javascript" src="<%=guideDir %>js/ctx/raqsoftApi.js?v=<%=v %>"></script>
</head>
