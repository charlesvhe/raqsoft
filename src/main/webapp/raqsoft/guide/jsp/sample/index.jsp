...
<head>
	...
	<frameset cols="25%,50%,25%">
		<frame name="frame1" src="<%=cp%>/raqsoft/guide/jsp/sample/param.jsp"/>
		<frame name="frame2" src="<%=cp%>/raqsoft/guide/jsp/sample/olap.jsp"/>
		<frame name="frame3" src="<%=cp%>/raqsoft/guide/jsp/sample/showReport.jsp"/>
	</frameset>
</html>
