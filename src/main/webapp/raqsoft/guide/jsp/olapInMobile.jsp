...
String olap = (String) request.getParameter( "olap" );
if (olap == null) olap = "";
...
<script src="../dbd/js/jquery.min.js"></script>
<script src="../dbd/js/code.jquery.com.jquery.js"></script>
<script src="../../../js/bootstrap.min.js"></script>
<script src="../dbd/js/mobile.js"></script>
<link  rel="stylesheet" href="../dbd/css/DBD.css"/>
<link  rel="stylesheet" href="../dbd/css/style.css"/>
...
<div class="container-fluid">
 <div class="row-fluid">
    ...
    <div class="span12 dbd-center">
      <!--Body content-->
      <div class="main">
      	<div id="contents" class="dtable" style="position:absolute;font-size:14px;height:100%;width:100%;overflow:hidden">
...
guideConf.reportPage = "showReport_m.jsp";
var sqlDatasets = [
	{
		sqlId:"sqlId1"
