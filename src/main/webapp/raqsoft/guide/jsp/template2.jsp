...
<head>
	...
	<script type="text/javascript" src="<%=guideDir %>js/common_d.js?v=<%=v %>"></script>
	...
	<script type="text/javascript" src="<%=guideDir %>js/dqlApi_d.js?v=<%=v %>"></script>
	...
	<script type="text/javascript" src="<%=guideDir %>js/where_d.js?v=<%=v %>"></script>
	<script type="text/javascript" src="<%=guideDir %>js/jquery-powerFloat/js/mini/jquery-powerFloat-min.js"></script>	
	<script type="text/javascript" src="<%=guideDir %>js/query_d.js?v=<%=v %>"></script>
	<script type="text/javascript" src="<%=guideDir %>js/dqlreport_d.js?v=<%=v %>"></script>
	<script type="text/javascript" src="<%=guideDir %>js/raqsoftApi_d.js?v=<%=v %>"></script>
</head>
