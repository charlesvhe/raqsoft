...
(function($, document) {
	...
	var domBuffer = '<div class="mui-dtpicker" data-type="datetime">\
		<div class="mui-dtpicker-header">\
			<table width=100%><tr>\
				<td width=40><span data-id="btn-cancel" class="mui-dtpicker-btn-cancel"></span></td>\
				<td align=center><span data-id="btn-clear" class="mui-dtpicker-clear">清空</span></td>\
				<td width=40><span data-id="btn-ok" class="mui-dtpicker-btn-ok"></span></td>\
			</tr></table>\
		</div>\
	...
	var DtPicker = $.DtPicker = $.Class.extend({
		init: function(options) {
			...
			var ui = self.ui = {
				...
				clear: $('[data-id="btn-clear"]', _picker)[0],
			...
			ui.clear.addEventListener('tap', function() {
				var rs = self.callback( {value:"",text:""} );
				if (rs !== false) {
					self.hide();
				}
			}, false);
		...
		setSelectedValue: function(value) {
			...
			//上面这段原始程序只能设置年，月以后的数据都不能设置，所以被sjr改成如下
			ui.y.picker.setSelectedValue(parsedValue.y, 0, function(){});
			ui.m.picker.setSelectedValue(parsedValue.m, 0, function(){});
			ui.d.picker.setSelectedValue(parsedValue.d, 0, function(){});
			ui.h.picker.setSelectedValue(parsedValue.h, 0, function(){});
