			...
			<form class="mui-input-group" style="display:none">
				<ul class="mui-table-view mui-table-view-chevron">
					<li class="mui-table-view-cell">
						管理员
						<div id="isManager" class="mui-switch">
		...
		<script>
			(function($, doc) {
				...
				//$.plusReady(function(){
					...
					//检查 "登录状态/锁屏状态" 开始
					if (settings.isManager && state.token && settings.gestures) {
						$.openWindow({
							url: 'unlock.html',
							id: 'unlock',
							show: {
					...
					} else if (settings.isManager && state.token) {
						toMain();
					}  else {
						app.setState(null);
						//第三方登录
					...
					var isManagerButton = doc.getElementById("isManager");
					...
					//isManagerButton.classList[settings.isManager ? '1' : '0']('mui-active')
					isManagerButton.addEventListener('toggle', function(event) {
